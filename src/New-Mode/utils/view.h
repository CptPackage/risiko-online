...
extern void print_framed_text_left(char *text, char frame_char,
                                   bool vertical_frame, Colors text_color,
                                   Colors frame_color);
extern void print_framed_text(char *text, char frame_char, bool vertical_frame,
                              Colors text_color, Colors frame_color);
extern void print_error_text(char *text);
extern void print_warning_text(char *text);
extern void print_info_text(char *text);
